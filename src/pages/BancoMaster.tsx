...
import {
  ArrowLeft, Lock, LockOpen, FileText, Gavel, Scale, Eye, Loader2, Shield, Clock,
} from "lucide-react";

const PREVIEW = [
  {
    tag: "AMOSTRA GRÁTIS",
    title: "STF libera sigilo de 53 processos do caso Banco Master",
    excerpt:
      "O ministro Mendonça autorizou o acesso público a 53 processos ligados à investigação — cerca de 25,3GB de material — nos dias 10 e 11 de setembro de 2026. Fonte: STF / imprensa.",
    date: "10-11/09/2026",
  },
  {
    tag: "AMOSTRA GRÁTIS",
    title: "PET 16.662 — julgamento sobre mensagens entre Vorcaro e Moraes",
    excerpt:
      "Petição que discute o vazamento e o conteúdo de mensagens trocadas entre Daniel Vorcaro e o ministro Alexandre de Moraes vai a julgamento no STF. Fonte: STF.",
    date: "15/09/2026",
  },
  {
    tag: "AMOSTRA GRÁTIS",
    title: "PET 15.556 mantém a prisão de Daniel Vorcaro",
    excerpt:
      "Decisão do STF que manteve a prisão do ex-controlador do Banco Master. Fonte: STF.",
    date: "2026",
  },
];

const LOCKED = [
  { title: "Linha do tempo completa do caso, atualizada a cada novo processo liberado", tag: "Atualizado semanalmente" },
  { title: "Lista dos processos do STF com sigilo levantado — número, relator e resumo em português simples", tag: "STF" },
  { title: "Compilado de reportagens (G1, Estadão, Valor, O Globo) organizado por data, com link direto pra cada fonte", tag: "Imprensa" },
  { title: "Glossário: o que significa cada petição/inquérito, sem juridiquês", tag: "Guia rápido" },
];
        ...
        <div className="container mx-auto max-w-3xl text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-alert/10 border border-alert/30 mb-5">
            ...
            <span className="text-[10px] md:text-xs font-mono text-alert uppercase tracking-wider">
              Dossiê Banco Master — documentos públicos STF + imprensa
            </span>
          </div>
          <h1 className="text-3xl md:text-5xl font-black text-foreground leading-tight mb-4">
            O caso <span className="text-alert">Banco Master</span>, do começo ao fim.
          </h1>
          <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto">
            Curadoria dos processos do STF e da cobertura da imprensa, organizada em linha do tempo.
      ...
      <section className="py-10 md:py-14 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="text-lg md:text-xl font-bold text-foreground">Amostra grátis · 3 fatos abertos</h2>
        ...
        <div className="container mx-auto max-w-4xl">
            ...
            {LOCKED.map((d, i) => (
              <div key={i} className="relative flex items-center gap-3 p-4 rounded-lg bg-card border border-border">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[10px] font-mono text-muted-foreground mt-1">{d.tag}</p>
                </div>
          ...
          <Card className="border-terminal/30 bg-card p-6 md:p-8">
            <h3 className="text-xl md:text-2xl font-black text-foreground text-center mb-2">
              Desbloquear dossiê Banco Master
            </h3>
            ...
            <div className="mt-6 grid grid-cols-3 gap-3 text-center">
              <div>
                <Gavel className="w-5 h-5 mx-auto mb-1 text-terminal" />
                <p className="text-[10px] text-muted-foreground">53 processos</p>
              </div>
              <div className="border-x border-border">
                <Scale className="w-5 h-5 mx-auto mb-1 text-alert" />
                <p className="text-[10px] text-muted-foreground">Fonte: STF</p>
              </div>
              <div>
                <Clock className="w-5 h-5 mx-auto mb-1 text-warning" />
                <p className="text-[10px] text-muted-foreground">Atualizado toda semana</p>
              </div>
            </div>
          </Card>
        </div>
      ...
      <footer className="py-8 px-4 border-t border-border">
        <div className="container mx-auto text-center">
          <p className="text-xs text-muted-foreground">
            © 2026 TV Oculta — Processos e reportagens de domínio público, com fonte citada em cada item.
          </p>
        </div>
      </footer>
    </div>
